...
/* harmony import */ var webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! webextension-polyfill-ts */ "./node_modules/webextension-polyfill-ts/dist/index.js");
...
class PortManager {
    constructor() {
        ...
        this.start = () => {
            ...
            this.port = webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__["browser"].runtime.connectNative('google_translate_bridge');
            this.port.postMessage({ msg: 123 });
...
portManager.start();
webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__["browser"].runtime.onInstalled.addListener(({ reason }) => {
    setTimeout(() => {
        if (reason === 'install' && !portManager.connected) {
            webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__["browser"].tabs.create({ url: webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__["browser"].runtime.getURL('welcome.html') });
        }
    }, 1000);
});
